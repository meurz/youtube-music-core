...
The compiled binary uses `rquickjs`, `rquickjs-core` and `rquickjs-sys` 0.12.2
(<https://github.com/DelSkayn/rquickjs>), licensed MIT; see `rquickjs-LICENSE`.
The bundled QuickJS-ng engine declares version 0.15.1 in `quickjs.h`
(<https://github.com/quickjs-ng/quickjs>), licensed MIT; see `quickjs-ng-LICENSE`.

These notices are copied unchanged from the crates.io 0.12.2 distributions.
